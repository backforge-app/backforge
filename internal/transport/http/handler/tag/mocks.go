...
// Source: github.com/backforge-app/backforge/internal/transport/http/handler/tag (interfaces: Service)
...
func (m *MockService) Create(arg0 context.Context, arg1 string, arg2 *uuid.UUID) (uuid.UUID, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetByID(arg0 context.Context, arg1 uuid.UUID) (*domain.Tag, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context) ([]*domain.Tag, error) {
	m.ctrl.T.Helper()
